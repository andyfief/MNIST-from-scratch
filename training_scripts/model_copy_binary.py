...
train_file = open('./MNIST_Data/binary_centered_train.csv', 'r')
train_list = train_file.readlines()
train_file.close()

test_file = open('./MNIST_Data/binary_centered_test.csv', 'r')
...
def save_model_weights(model, filename='binary_mnist_model_weights.pkl'):
    weights = {
        'W1': model.params['W1'],
        'W2': model.params['W2'],
        'W3': model.params['W3']
